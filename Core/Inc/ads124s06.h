...
void ads124s06_init_pt1000(void);
void ads124s06_cmd_nop(void);
void ads124s06_cmd_wakeup(void);
void ads124s06_cmd_powerdown(void);
void ads124s06_cmd_reset(void);
void ads124s06_cmd_start(void);
void ads124s06_cmd_stop(void);
void ads124s06_send_command(uint8_t op_code);
void ads124s06_write_reg(uint8_t address, uint8_t data);
void ads124s06_read_reg(uint8_t address, uint8_t *data);
uint8_t ads124s06_rtd_read(int32_t* rtd);
uint8_t read_rtd(int32_t* rtd);
float rtd_to_resist(int32_t rtd,float ref_res_val);
void select_mux(uint8_t num);
float sel_readsensor_temp_resistor(uint8_t sel,float* res,control_flag *flag,uint8_t value);
float read_temp_1st(control_flag *flag_control,uint32_t num,float *resist);
float read_temp_2nd(control_flag *flag_control,uint32_t num,float *resist);
float resistor_to_temperature(float res);
uint8_t tmp_sensor_config(control_flag *flag);
void solve_system_3x3(double a[3][3], double b[3], double x[3]);
float pt1000_read_temp_3point_cal(control_flag *flag_control,uint32_t num,float *resist);
float pt1000_0_read_temp_3point_cal(control_flag *flag_control,uint32_t num,float *resist);
